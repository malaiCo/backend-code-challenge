...
var neoController = require('../controller/neo');
...
describe('Test the Routes', () => {
    ...
    it('should return all Neos', async () => {
        ...
        const result = await neoController.getAllNeos();
    ...
    it('Test route get the fastest Neo', async () => {
        ...
        const result = await neoController.getFastestNeo(true);
    ...
    it('Test route get best month', async () => {
        ...
        NeoMock.expects('aggregate').withArgs([{
            ...
            .withArgs(1)
            .resolves(expectedResult);
        const result = await neoController.getBestMonth(true);
    ...
    it('Test route get best year', async () => {
        ...
        NeoMock.expects('aggregate').withArgs([{
            ...
            .withArgs(1)
            .resolves(expectedResult);
        const result = await neoController.getBestYear(true);
        expect(result.length).to.equal(1);
    ...
    it('Test route to add a new Neo', async () => {
        ...
        const result = await neoController.addNeo(neoToAdd);
    ...
    it('Test route to add wrong neo', async () => {
        ...
        try {
            await neoController.addNeo(neoToAdd);
